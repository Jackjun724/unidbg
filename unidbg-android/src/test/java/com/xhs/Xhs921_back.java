...
public class Xhs921_back extends AbstractJni {
    ...
    Xhs921_back() {
        String traceFile = "unidbg-android/src/test/java/com/xhs/trace/trace_init3.txt";
        try {
    ...
    public static void main(String[] args) throws Exception {
        Xhs921_back xhs = new Xhs921_back();

        // Hook fstatat64 (syscall 79) 查看被stat的路径
        // xhs.hookFstatat();
        // Hook JSON key-value put 操作
        // xhs.hookJsonPut();
        // Hook base64 encode to capture header/payload raw data
        // xhs.hookBase64Encode();
        xhs.init1();
        xhs.trace();
        xhs.init3();
            ...
            case "com/xingin/tiny/internal/t->b(I[Ljava/lang/Object;)Ljava/lang/Object;": {
                switch (vaList.getIntArg(0)) {
                    ...
                    case 1798473208:
                        ...
                        return new ArrayObject(new DvmObject<?>[0]);
                    case -118611111:
